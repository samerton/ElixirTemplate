...
<html lang="en">
  <head>
	...
	<?php $title = $navbar_language['forum'] . ' - ' . $forum_language['report_post']; ?>
  ...
  <body>
	...
	// Avatar
	$avatar = '<img class="img-circle" style="width:100px; height:100px;" src="' . $user->getAvatar($reported_post[0][0], "../", 100) . '" />';
    ...
    $content = 	'<div class="row">' . PHP_EOL .
                ...
                '    <div class="post-sidebar">' . PHP_EOL .
                '      <center class="post-user-avatar">' . $avatar . '</center>' . PHP_EOL .
                '        <div class="post-user-info">' . PHP_EOL .
                '          <span class="post-user-name"><a href="/profile/' . htmlspecialchars($user->IdToMCName($reported_post[0][0])) . '">' . htmlspecialchars($user->IdToName($reported_post[0][0])) . '</a></span><br />' . PHP_EOL .
                '        </div>' . PHP_EOL .
                '      </div>' . PHP_EOL .
                '    </div>' . PHP_EOL .
                '  <div class="col-md-10 post-content">' . PHP_EOL .
                '    <div class="forum_post">' . PHP_EOL .
                '      ' . $clean . PHP_EOL .
                '    </div>' . PHP_EOL .
                '    <hr />' . PHP_EOL .
                '    <span class="post-info">By <a href="/profile/' . htmlspecialchars($user->IdToMCName($reported_post[0][0])) . '">' . htmlspecialchars($user->IdToName($reported_post[0][0])) . '</a> : ' . date("d M Y, H:i", strtotime($reported_post[2][0])) . '</span>' . PHP_EOL .
                '  </div>' . PHP_EOL .
                '</div>';
