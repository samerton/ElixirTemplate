...
<html lang="en">
  <head>
	...
	<?php $title = $navbar_language['forum'] . ' - ' . $forum_language['new_topic']; ?>
  ...
  <body>
	...
	$form_content = '<form action="" method="post">' . PHP_EOL .
					...
					'  </div>' . PHP_EOL .
					'  <div class="panel-body" style="padding: 10px 15px;"><strong>' . $forum_language['label'] . ':</strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" name="topic_label" value="0" checked> <span class="label label-default">' . $general_language['none'] . '</span>&nbsp;&nbsp;' . $labels . '</div>' . PHP_EOL .
					'  <br /> ' . PHP_EOL .
					'  <div class="form-group">' . PHP_EOL .
