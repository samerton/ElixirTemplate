<div class="panel panel-default">
  <div class="panel-heading"><i class="fas fa-bars"></i>Navigation</div>
  <div class="panel-body">
	<ul class="nav nav-pills nav-stacked">
	  <li<?php if($mod_page == 'index'){ ?> class="active"<?php } ?>><a href="/mod"><?php echo $mod_language['overview']; ?></a></li>
	  <li<?php if($mod_page == 'reports'){ ?> class="active"<?php } ?>><a href="/mod/reports"><?php echo $mod_language['reports']; ?> <?php if($reports == true){ ?>&nbsp<i class="fas fa-exclamation-circle"></i><?php } ?></a></li>
