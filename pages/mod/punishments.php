...
<html lang="en">
  ...
  <body>
    ...
    <div class="container index">
      <h3><?php echo $mod_language['punishments']; ?></h3>
      <br />
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          <div class="panel-body">
            <?php if(Session::exists('punishment_error')){ echo Session::flash('punishment_error'); } ?>
            ...
            <form role="form" action="" method="post">
              <label><?php echo $mod_language['reason']; ?></label>
            ...
            ?>
          <?php } else if(!isset($_GET["uid"]) && isset($_GET["action"]) && isset($_GET["ip"])) { ?>
              	...
              	if(Input::exists()){
              		if(Token::check(Input::get('token'))) {
              			if(Input::get('action') === "search"){
              			  ...
              			  ?>
            <h4 class="inline"><?php echo $mod_language['user'] . ' ' . htmlspecialchars($search_result->username); ?></h4>
            <br />
            <span class="tagline"><strong><?php echo $admin_language['ip']; ?></strong> <a target="_blank" href="/mod/punishments/?action=lookup&ip=<?php echo str_replace(".", "-", htmlspecialchars($search_result->lastip)); ?>"><?php echo htmlspecialchars($search_result->lastip); ?></a></span>
            <br /><br />
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      <label><?php echo $mod_language['search_for_a_user']; ?></label>
