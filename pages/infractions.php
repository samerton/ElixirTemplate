...
<html lang="en">
  <head>
    ...
    <?php $title = $infractions_language['infractions']; ?>
    ...
    <div class="container index">
      ...
      <div class="panel-body">
        ...
        <?php
          ...
          ?>
        <h4 class="inline"><?php echo $infractions_language['viewing_infraction']; ?></h4>
        ...
        <?php echo $infractions_language['staff_member'] . ': ' . (strtolower($staff) == 'console' ? $staff : '<a href="/profile/' . $staff . '">' . $staff . '</a>'); ?><br /><br />
        <?php echo $infractions_language['action'] . ': <strong>' . $action . '</strong>'; ?><br />
        <?php if(isset($created)) echo $infractions_language['created'] . ': ' . $created . '<br /><br />'; ?>
        <?php if(isset($expires)) echo $infractions_language['status'] . ' ' . $expires . '<br /><br />'; ?>
        <?php echo $infractions_language['reason'] . ': '; ?><?php echo $reason; ?><br />
        <?php } ?>
      </div>
    </div>
