...
if($custom_usernames == "false"){ 
    $custom_usernames_text = $user_language['minecraft_username']; 
} else {
    $custom_usernames_text = $user_language['username'];
...
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $custom_usernames_text . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="text" name="username" id="username" autocomplete="off" value="' . escape(Input::get('username')) . '" class="form-control input-lg" tabindex="1">
  </div>
</div>';
...
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['minecraft_username'] . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="text" name="mcname" id="mcname" autocomplete="off" class="form-control input-lg" tabindex="2">
  </div>
</div>';
}
...
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['email_address'] . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="email" name="email" id="email" value="' . escape(Input::get('email')) . '" class="form-control input-lg" tabindex="3">
  </div>
</div>
<hr />
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['date_of_birth'] . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="text" class="form-control input-lg datepicker" name="birthday" id="birthday" tabindex="4">
  </div>
</div>
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['location'] . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="text" name="location" id="location" class="form-control input-lg" tabindex="5">
  </div>
</div>
<hr />
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['password'] . ':</label>
  </div>
  <div class="col-sm-7">
...
<div class="form-group">
  <div class="col-sm-5">
    <label>' . $user_language['confirm_password'] . ':</label>
  </div>
  <div class="col-sm-7">
	<input type="password" name="password_again" id="password_again" class="form-control input-lg" tabindex="7">
  </div>
</div>
';
...
$form_submit = '
  ...
  <div class="row">
    <div class="col-sm-7 col-sm-offset-5" style="margin-top:10px;margin-bottom:8px;">
      <input type="checkbox" name="t_and_c" id="t_and_c" data-color="info" value="1"> ' . $user_language['agree_t_and_c'] . '.
      <br /><br />
    </div>
  </div>
  <div class="row">
    <div class="col-sm-7 col-sm-offset-5">
      <button type="submit" class="btn btn-primary btn-md">' . $user_language['register'] . '</button>
    </div>
  </div>
  ';
...
<html lang="en">
  <head>
    ...
    <?php $title = $user_language['register']; ?>
