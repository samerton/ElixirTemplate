...
<html lang="en">
  <head>
	...
	<?php $title = $admin_language['custom_pages']; ?>
  ...
  <body>
    ...
    <div class="container index">
      <h3><?php echo $admin_language['custom_pages']; ?></h3>
      <br />
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          ...
          <div class="panel-body">
            <h4 class="inline"><?php echo $admin_language['custom_pages']; ?></h4>
            <span class="pull-right"><a href="/admin/pages/?action=new" class="btn btn-primary"><?php echo $admin_language['new_page']; ?></a></span>
            <br />
            <span class="tagline"><?php echo $admin_language['click_on_page_to_edit']; ?></span>
            <br /><br />
            <?php if(Session::exists('custom-pages')){ echo Session::flash('custom-pages'); } ?>
            <?php
          ...
          <div class="panel-body post-body">
            <h4 class="inline"><?php echo $admin_language['page']; ?> <?php echo htmlspecialchars($page[0]->title); ?></h4>
            ...
            <br />
            <span class="tagline"><strong><?php echo $admin_language['url']; ?></strong> http://<?php echo $_SERVER['SERVER_NAME'] . htmlspecialchars($page[0]->url); ?></span>
            <br /><br />
            <?php if(Session::exists('custom-pages')){ echo Session::flash('custom-pages'); } ?>
            ...
            <br />
              <div class="panel-body">
                <h5><?php echo $admin_language['page_content']; ?></h5>
                <br />
              ...
              <div class="panel-body">
                <div class="form-group">
                  <h5><?php echo $admin_language['page_permissions']; ?></h5>
                  <br />
                  <?php $group_perms = $queries->getWhere('custom_pages_permissions', array('page_id', '=', $_GET["page"])); ?>
                  <?php
                  ...
                  <table class="table table-formed" style="border-bottom: solid 1px #f5f5f5;">
                    <thead>
                      <tr>
                        <th>Groups</th>
                        <th><?php echo $admin_language['can_view_page']; ?></th>
                      </tr>
                    </thead>
                  <tbody>
                    <tr>
                      ...
                      <td class="info">
                        <input onclick="colourUpdate(this);" name="perm-view-0" id="Input-view-0" value="1" type="checkbox"<?php if(isset($view) && $view == 1){ echo ' checked'; } ?>>
                      </td>
                    </tr>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="info">
                          <input onclick="colourUpdate(this);" name="perm-view-<?php echo $group->id; ?>" id="Input-view-<?php echo $group->id; ?>" value="1" type="checkbox"<?php if(isset($view) && $view == 1){ echo ' checked'; } ?>>
                        </td>
                      </tr>
          ...
          ?>
          <div class="panel-body post-body">
            <h4><?php echo $admin_language['new_page']; ?></h4>
            <br />
            <?php if(isset($error)){ echo $error; } ?>
            <div class="panel-body">
              <form action="" method="post">
