...
<html lang="en">
  ...
  <body>
    ...
    <div class="container index">
      <h3><?php echo $admin_language['core']; ?></h3>
      <br />
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          ...
          ?>
          <div class="panel-body">
            <h4><?php echo $admin_language['general_settings']; ?></h4>
            <br />
            <?php if(Session::exists('general_settings')){ echo Session::flash('general_settings'); } ?>
            <form action="" method="post">
              ...
              <div class="form-group">
                ...
                <label for="followers"><?php echo $admin_language['use_followers']; ?></label> <i class="fas fa-question-circle" data-toggle="popover" data-content="<?php echo $admin_language['use_followers_help']; ?>"></i>
              </div>
              <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
              <input type="submit" class="btn btn-primary" value="<?php echo $general_language['submit']; ?>">
            </form>
          </div>
          <?php } else { if($_GET['view'] == 'modules'){ ?>
          <?php if(Session::exists('core_modules')){ echo Session::flash('core_modules'); }?>
          <?php if(!isset($_GET['action']) && !isset($_GET['activate']) && !isset($_GET['deactivate'])){ ?>
          <div class="panel-body">
            <h4><?php echo $admin_language['modules']; ?></h4>
            <br />
            <?php
            ...
            ?>
              <span style="display:inline-block;padding:4px;"><?php echo htmlspecialchars(str_replace('_', ' ', $module->name)); ?></span>
            <?php if($module->enabled == 1){ ?>
              <span class="pull-right"><a href="/admin/core/?view=modules&amp;deactivate=<?php echo htmlspecialchars($module->name); ?>" style="width: 100px;" class="btn btn-danger btn-sm"><?php echo $admin_language['deactivate']; ?></a> <a href="/admin/core/?view=modules&action=edit&module=<?php echo htmlspecialchars($module->name); ?>" class="btn btn-info btn-sm"><i class="fas fa-cog"></i></a></span>
            <?php } else { ?>
              <span class="pull-right"><a href="/admin/core/?view=modules&amp;activate=<?php echo htmlspecialchars($module->name); ?>" style="width: 100px;" class="btn btn-success btn-sm"><?php echo $admin_language['activate']; ?></a> <a href="/admin/core/?view=modules&action=edit&module=<?php echo htmlspecialchars($module->name); ?>" class="btn btn-info btn-sm"><i class="fas fa-cog"></i></a></span>
            <?php } ?>
            <hr>
            <?php } ?>
          </div>
          ...
          <div class="panel-body">
            ...
            <br />
            <?php if(Session::exists('google_analytics_settings')){ echo Session::flash('google_analytics_settings'); } ?>
            <form action="" method="post">
              <label for="tracking"><?php echo $admin_language['tracking_code']; ?></label> <i class="fas fa-question-circle" data-toggle="popover" data-content="<?php echo $admin_language['tracking_code_help']; ?>"></i>
          ...
          <?php } else if($_GET['module'] == 'Social_Media'){ ?>
          <?php
            	// Deal with input
            	if(Input::exists()){
            		if(Token::check(Input::get('token'))){
          ...
          <div class="panel-body">
            ...
            <br />
            <?php if(Session::exists('social_media_links')){ echo Session::flash('social_media_links'); } ?>
            <form action="" method="post">
              <div class="form-group">
          ...
          <?php } else if($_GET['module'] == 'Registration'){ ?>
          <?php
            	// Deal with input
            	if(Input::exists()){
            		if(Token::check(Input::get('token'))){
          ...
          <div class="panel-body">
            ...
            <span class="tagline"><?php echo $admin_language['registration_warning']; ?></span>
            <br /><br />
            <?php if(Session::exists('registration_settings')){ echo Session::flash('registration_settings'); } ?>
            <form action="" method="post">
              <div class="form-group">
          ...
          <?php } else if($_GET['module'] == 'Voice_Server_Module'){ ?>
          <?php
            	// Deal with input
            	if(Input::exists()){
            		if(Token::check(Input::get('token'))){
          ...
          <div class="panel-body post-body">
            ...
            <span class="tagline"><?php echo $admin_language['only_works_with_teamspeak']; ?></span>
            <br /><br />
            <?php if(Session::exists('voice_server_settings')){ echo Session::flash('voice_server_settings'); } ?>
            <?php
              // Get Discord ID
            ...
            <div class="panel-body">
              <h5>TeamSpeak</h5>
              <span class="tagline"><?php echo $admin_language['voice_server_help']; ?></span>
              <hr />
              <form action="" method="post">
                <div class="form-group">
          ...
          <?php } else if($_GET['module'] == 'Staff_Applications'){ ?>
          <div class="panel-body post-body">
            <h4><?php echo $navbar_language['staff_apps']; ?></h4>
            <br />
            <?php if(!isset($_GET['module_action']) && !isset($_GET['question'])){ ?>
            <?php if(Session::exists('apps_post_success')){ echo Session::flash('apps_post_success'); } ?>
            <?php
              	if(Input::exists()){
              		if(Token::check(Input::get('token'))){
              			// Group permissions
            ...
            <div class="panel-body">
              <form role="form" action="" method="post">
                <div class="form-group">
                  <h5><?php echo $admin_language['permissions']; ?></h5>
                  <br />
                  <table class="table table-formed" style="border-bottom: 1px #f5f5f5 solid">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th><?php echo $admin_language['view_applications']; ?></th>
                        <th><?php echo $admin_language['accept_reject_applications']; ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      <tr>
                        ...
                        <td><input id="view-<?php echo $group->id; ?>" name="view-<?php echo $group->id; ?>" type="checkbox" class="js-switch" <?php if($group->staff_apps == 1){ ?>checked <?php } ?>/></td>
                        <td><input id="accept-<?php echo $group->id; ?>" name="accept-<?php echo $group->id; ?>" type="checkbox" class="js-switch" <?php if($group->accept_staff_apps == 1){ ?>checked <?php } ?>/></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
            ...
            <div class="panel-body">
              ...
              <span class="pull-right"><a href="/admin/core/?view=modules&amp;action=edit&amp;module=Staff_Applications&amp;module_action=new" class="btn btn-primary"><?php echo $admin_language['new_question']; ?></a></span>
              <br />
              <table class="table table-formed" style="border-bottom: 1px solid #f5f5f5">
                ...
                <tbody>
                  ...
                  <?php echo '<a href="/admin/core/?view=modules&action=edit&module=Staff_Applications&question=' . $question->id . '"></a><br />'; } } else { ?>
                  <tr>
            ...
            <?php } ?>
            <div class="panel-body">
              <h5 class="inline"><?php echo $admin_language['editing_question']; ?></h5>
            ...
            <?php } else if(isset($_GET['module_action']) && $_GET['module_action'] == 'new') { ?>
            <?php
              	// Deal with the input
              	if(Input::exists()){
              		if(Token::check(Input::get('token'))){
            ...
            <?php } ?>
            <div class="panel-body">
              <h5><?php echo $admin_language['new_question']; ?></h5>
              <br />
              <form method="post" action="">
                <label for="name"><?php echo $admin_language['name']; ?></label>
              ...
              <div class="panel-body">
                <form action="" method="post">
                  <div class="form-group">
                    ...
                    <label for="InputEnableVerification">&nbsp;<?php echo $admin_language['enable_mail_verification']; ?></label> <i class="fas fa-question-circle" data-toggle="popover" data-content="<?php echo $admin_language['enable_email_verification_help']; ?>"></i>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="InputOutgoingEmail"><?php echo $admin_language['outgoing_email']; ?></label> <i class="fas fa-question-circle" data-toggle="popover" data-content="<?php echo $admin_language['outgoing_email_help']; ?>"></i>
                  ...
                  <div class="form-group">
                    ...
                    <label for="InputEnableExternal">&nbsp;<?php echo $admin_language['use_php_mail']; ?></label> <i class="fas fa-question-circle" data-toggle="popover" data-content="<?php echo $admin_language['use_php_mail_help']; ?>"></i>
                  </div>
                </div>
                <br />
                <div class="panel-body">
            ...
            <?php
              ...
              <div class="panel-body">
                ...
                <span class="h3-tagline"><?php echo $admin_language['enable_or_disable_pages']; ?></span>
                <br /><br />
