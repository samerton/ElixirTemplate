...
<html lang="en">
  <head>
    ...
    <?php if(isset($custom_meta)){ echo $custom_meta; } ?>
    <?php $title = $admin_language['forums']; ?>
  ...
  <body>
    ...
    <div class="container index">
      <h3><?php echo $admin_language['forums']; ?></h3>
      <br />
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          ...
          <?php if(Session::exists('adm-forums')){ echo Session::flash('adm-forums'); } ?>
          <?php if(!isset($_GET["action"]) && !isset($_GET["forum"])){ ?>
          <?php
            if(Input::exists()) {
            ...
            ?>
          <div class="panel-body">
            <h4 class="inline"><?php echo $admin_language['forums']; ?></h4>
            <a href="/admin/forums/?action=new" class="btn btn-primary pull-right"><?php echo $admin_language['new_forum']; ?></a>
            <br /><br /><br />
            <?php 
            ...
            <span style="display:inline-block;padding:4px;">
              <?php echo '<a href="/admin/forums/?forum=' . $forum->id . '">' . $purifier->purify(htmlspecialchars_decode($forum->forum_title)) . '</a>'; ?>
            </span>
            <span class="pull-right">
              <?php if($i !== 1){ ?><a href="/admin/forums/?action=order&amp;dir=up&amp;fid=<?php echo $forum->id;?>" class="btn btn-success btn-sm"><i class="fas fa-angle-up"></i></a><?php } else { ?><a class="btn btn-success btn-sm disabled"><i class="fas fa-angle-up"></i></a><?php } ?>
              <?php if($i !== $number){ ?><a href="/admin/forums/?action=order&amp;dir=down&amp;fid=<?php echo $forum->id;?>" class="btn btn-warning btn-sm"><i class="fas fa-angle-down"></i></a><?php } else { ?><a class="btn btn-warning btn-sm disabled"><i class="fas fa-angle-down"></i></a><?php } ?>
              <a href="/admin/forums/?action=delete&amp;fid=<?php echo $forum->id;?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
            </span>
            <hr />
            <?php $i++; } ?>
          ...
          <?php } } ?>
          <div class="panel-body">
            <h4><?php echo $admin_language['create_forum']; ?></h4>
            <br />
            <form action="" method="post">
              <div class="form-group">
                <label><?php echo $admin_language['forum_name']; ?></label>
                <input class="form-control" type="text" name="forumname" id="forumname" value="<?php echo escape(Input::get('forumname')); ?>" autocomplete="off">
              </div>
              <div class="form-group">
                <label><?php echo $admin_language['forum_description']; ?></label>
                <textarea name="forumdesc" class="form-control" rows="3"></textarea>
              </div>
              <div class="form-group">
                <input type="radio" name="forum_type" value="forum" checked>
                <label class="label label-info"><?php echo $admin_language['forum_type_forum']; ?></label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="forum_type" value="category">
                <label class="label label-warning"><?php echo $admin_language['forum_type_category']; ?></label>
              </div>
          ...
          <?php 
            	...
            	?>
          <div class="panel-body">
            <h4><?php echo $admin_language['delete_forum']; ?></h4>
            <br />
            <form role="form" action="" method="post">
              <label><?php echo $admin_language['move_topics_and_posts_to']; ?></label>
          ...
          <div class="panel-body post-body">
            <h4><?php echo htmlspecialchars($forum[0]->forum_title); ?></h4>
            <br />
            <div class="panel-body">
              <form role="form" action="" method="post">
                <div class="form-group">
                ...
                <div class="form-group" <?php if($forum[0]->forum_type == 'category') { echo'style="display:none;"'; } else { echo'style="margin-bottom:0;"'; } ?>>
            ...
            <br />
            <div class="panel-body">
              <h5><?php echo $admin_language['forum_permissions']; ?></h5>
              <br />
              <div class="form-group">
            <?php
          ...
          <?php 
            ...
            ?>
          <div class="panel-body">
            <h4 class="inline"><?php echo $admin_language['labels']; ?></h4>
            <a href="/admin/forums/?view=labels&amp;action=create" class="btn btn-primary pull-right"><?php echo $admin_language['new_label']; ?></a>
            <br /><br /><br />
            <?php if(Session::exists('forum_labels')){ echo Session::flash('forum_labels'); } ?>
            <?php
              if(count($topic_labels)){
              // Display list of all labels
              foreach($topic_labels as $topic_label){
            ?>
            <span style="display:inline-block;padding:4px"><span class="label label-<?php echo htmlspecialchars($topic_label->label); ?>"><?php echo htmlspecialchars($topic_label->name); ?></span></span>
            <span class="pull-right">
            <a href="/admin/forums/?view=labels&amp;action=edit&amp;lid=<?php echo $topic_label->id; ?>" class="btn btn-warning btn-sm"><span class="fas fa-pen"></span></a>
            <a onclick="return confirm('<?php echo $admin_language['confirm_label_deletion']; ?>');" href="/admin/forums/?view=labels&amp;action=delete&amp;lid=<?php echo $topic_label->id; ?>" class="btn btn-danger btn-sm"><span class="fas fa-trash-alt"></span></a>
            </span>
            <hr>
            <?php } ?>
            <?php
              ...
              echo '<div class="alert alert-danger">' . $admin_language['no_labels_defined'] . '</div>'; 
              } ?>
          </div>
          <?php
            	...
            	?>
          <div class="panel-body">
            <h4><?php echo $admin_language['new_label']; ?></h4>
            <br />
            <?php if(Session::exists('new_label_error')){ echo Session::flash('new_label_error'); } ?>
            <form action="" method="post">
              <div class="form-group">
          ...
          <?php
            	...
            	?>
          <div class="panel-body">
            <h4><?php echo $admin_language['editing_label']; ?></h4>
            <br />
            <?php if(Session::exists('editing_label_error')){ echo Session::flash('editing_label_error'); } ?>
            <form action="" method="post">
              <div class="form-group">
                <label for="label_name"><?php echo $admin_language['label_name']; ?></label>
