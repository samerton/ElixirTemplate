...
<html lang="en">
  <head>
    ...
    <?php $title = $admin_language['minecraft']; ?>
    ...
    <div class="container index">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="panel-body">
            <h4><?php echo $admin_language['minecraft_settings']; ?></h4>
            <br />
            <?php
              // Deal with input
              if(Input::exists()){
              ...
              if(Session::exists('mc_settings')){ echo Session::flash('mc_settings'); } ?>
              
            <form action="" method="post">
              <div class="form-group">
                <input id="plugin" name="plugin" type="checkbox" class="js-switch" <?php if($use_plugin[0]->value == '1'){ ?>checked <?php } ?>/>
                <label for="plugin">&nbsp;&nbsp;<?php echo $admin_language['use_plugin']; ?></label> <span data-toggle="popover" data-content="<?php echo $admin_language['use_plugin_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span><a href="/admin/minecraft/?settings=plugin" class="btn btn-info btn-sm pull-right"><?php echo $admin_language['settings']; ?></a>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <label for="uuids">&nbsp;&nbsp;<?php echo $admin_language['uuid_linking']; ?></label> <span data-toggle="popover" data-content="<?php echo $admin_language['uuid_linking_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span>
              </div>
              <div class="form-group">
          ...
          <div class="panel-body">
            <h4><?php echo $admin_language['plugin_settings']; ?></h4>
            <br />
            <?php
            ...
            <form action="" method="post">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-btn"><a style="margin-top:4px;margin-left:4px;" href="/admin/minecraft/?settings=plugin&amp;action=api_regen" onclick="return confirm('<?php echo $admin_language['confirm_api_regen']; ?>');" class="btn btn-info">Change</span></a>
                </div>
              </div>
              <input type="submit" class="btn btn-primary" value="<?php echo $general_language['submit']; ?>">
            </form>
          ...
          <div class="panel-body post-body">
            <h4 class="inline"><?php echo $admin_language['servers']; ?></h4>
            <a href="/admin/minecraft/?view=servers&amp;action=new" class="btn btn-primary pull-right"><?php echo $admin_language['new_server']; ?></a>
            <br /><br /><br />
            <?php if(Session::exists('admin_servers')){ echo Session::flash('admin_servers'); } ?>
            <div class="panel-body">
              <?php 
                ...
                ?>
              <h5><?php echo $admin_language['servers']; ?></h5>
              <br />
              <div class="row">
                <div class="col-md-6">
                  <a href="/admin/minecraft/?view=servers&amp;sid=<?php echo $server->id; ?>">
                    <?php echo htmlspecialchars($server->name) . '</a><br />' . htmlspecialchars($server->ip); ?>
                </div>
                <div class="col-md-6">
                <span class="pull-right">
                <a onclick="return confirm('<?php echo $admin_language['confirm_server_deletion']; ?>');" href="/admin/minecraft/?view=servers&amp;action=delete_server&amp;sid=<?php echo $server->id; ?>" class="btn btn-danger btn-sm"><span class="fas fa-trash-alt"></span></a>
                </span>
                </div>
              </div>
              <hr>
            ...
            <div class="panel-body">
              <form action="" method="post">
                <div class="form-group">
                  <label for="InputMain"><?php echo $admin_language['main_server']; ?> <span data-toggle="popover" data-content="<?php echo $admin_language['main_server_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span></label>
          ...
          <?php } else if(isset($_GET["sid"]) && !isset($_GET["action"])) { ?>
          <div class="panel-body">
            <?php
            ...
            <?php } } ?>
            <h4><?php echo str_replace('{x}', htmlspecialchars($server[0]->name), $admin_language['editing_server']); ?></h4>
            <br />
            <form action="" method="post">
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="serverip"><?php echo $admin_language['server_ip_with_port']; ?> <span data-toggle="popover" data-content="<?php echo $admin_language['server_ip_with_port_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span></label>
              ...
              <div class="form-group">
                <label for="queryip"><?php echo $admin_language['server_ip_numeric']; ?> <span data-toggle="popover" data-content="<?php echo $admin_language['server_ip_numeric_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span></label>
              ...
              <input name="display" id="InputDisplay" value="1" type="checkbox" class="js-switch"<?php if($server[0]->display == 1){ echo ' checked'; } ?>>
              <label for="InputDisplay">&nbsp;&nbsp;<?php echo $admin_language['show_on_play_page']; ?></label>
              <br /><br />
              <input type="hidden" name="pre" value="0" />
              <input name="pre" id="InputPre" value="1" type="checkbox" class="js-switch"<?php if($server[0]->pre == 1){ echo ' checked'; } ?>>
              <label for="InputPre">&nbsp;&nbsp;<?php echo $admin_language['pre_17']; ?></label>
              <br /><br />
              <input type="hidden" name="show_players" value="0" />
              <input name="show_players" id="InputShowPlayers" value="1" type="checkbox" class="js-switch"<?php if($server[0]->player_list == 1){ echo ' checked'; } ?>>
          ...
          <?php } else if(isset($_GET["action"])) { if($_GET["action"] === "new"){ ?>
          <div class="panel-body">
            <?php
              if(Input::exists()) {
              	if(Token::check(Input::get('token'))) {
            ...
            <?php } } ?>
            <form action="" method="post">
              <h4><?php echo $admin_language['new_server']; ?></h4>
              <br />
              <div class="form-group">
                <label for="servername"><?php echo $admin_language['server_name']; ?></label>
              ...
              <input type="hidden" name="display" value="0" />
              <input name="display" id="InputDisplay" value="1" type="checkbox" class="js-switch">
              <label for="InputDisplay">&nbsp;&nbsp;<?php echo $admin_language['show_on_play_page']; ?></label>
              <br /><br />
              <input type="hidden" name="pre" value="0" />
              <input name="pre" id="InputPre" value="1" type="checkbox" class="js-switch">
              <label for="InputPre">&nbsp;&nbsp;<?php echo $admin_language['pre_17']; ?></label>
              <br /><br />
              <input type="hidden" name="show_players" value="0" />
              <input name="show_players" id="InputShowPlayers" value="1" type="checkbox" class="js-switch">
              <label for="InputShowPlayers">&nbsp;&nbsp;<?php echo $admin_language['show_players']; ?></label>
              <br /><br />
              <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
              <input class="btn btn-primary" type="submit" value="<?php echo $general_language['submit']; ?>">
          ...
          ?>
          <div class="panel-body post-body">
            <h4 class="inline"><?php echo $admin_language['query_errors']; ?></h4>
            ...
            <br />
            <span class="tagline"><?php echo $admin_language['query_errors_info']; ?></span>
            <br /><br />
            <div class="panel-body">
              <?php
                ...
                ?>
              <table class="table table-formed dataTables-errors" >
                <colgroup>
                  <col style="width:40%">
                  <col style="width:20%">
                  <col style="width:30">
                ...
                <tbody>
                  <?php foreach($query_errors as $query_error){ ?>
                  <tr>
                    ...
                    <td class="pull-right"><a href="/admin/minecraft/?view=errors&amp;error=<?php echo $query_error->id; ?>" class="btn btn-primary btn-sm"><?php echo $user_language['view']; ?></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
              <?php } else { echo $admin_language['no_query_errors']; } ?>
            </div>
          </div>
          <?php
            } else {
            	...
            	if(isset($_GET['action']) && $_GET['action'] == 'delete'){
            		...
            		echo '<h4 style="display:inline;">' . $admin_language['viewing_error'] . '</h4>';
            		echo '<span class="pull-right"><a onclick="return confirm(\'' . $admin_language['confirm_error_deletion'] . '\');" href="/admin/minecraft/?view=errors&amp;action=delete&amp;error=' . $query_error->id . '" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a></span>';
            		echo '<br /><br />';
            		...
            		echo '<div class="panel panel-danger" style="margin-bottom:0;"><div class="panel-body"><p>' . htmlspecialchars($query_error->error) . '</p></div></div>';
            		echo '</div>';
            	}
            } 
            ...
            ?>
          <div class="panel-body">
            <h4><?php echo $admin_language['mcassoc']; ?></h4>
            <br />
            ...
            <form action="" method="post">
              <div class="form-group">
                <div class="form-group">
                  ...
                  <label for="use_mcassoc">&nbsp;&nbsp;<?php echo $admin_language['use_mcassoc']; ?></label> <span data-toggle="popover" data-content="<?php echo $admin_language['use_mcassoc_help']; ?>">&nbsp;<i class="fas fa-question-circle"></i></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <label><?php echo $admin_language['mcassoc_instance_help']; ?></label>
                </div>
                <div class="form-group">
                  <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                  <input type="submit" class="btn btn-primary" value="<?php echo $general_language['submit']; ?>">
