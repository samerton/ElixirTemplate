...
<html lang="en">
  <head>
    ...
    <?php $title = $admin_language['users']; ?>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <br />
        <?php if(Session::exists('adm-users')){ echo Session::flash('adm-users'); } ?>
        <?php
        ...
        <div class="panel-body post-body">
          <h4 class="inline"><?php echo $admin_language['users']; ?></h4>
          <a href="/admin/users/?action=new" class="btn btn-primary pull-right"><?php echo $admin_language['new_user']; ?></a>
          <br /><br /><br />
          <div class="panel-body">
          ...
          <?php } } ?>
          <div class="panel-body">
            <h4 class="inline"><?php echo $user_language['create_an_account']; ?></h4>
            <br /><br />
            <form action="" method="post">
              <div class="form-group">
                <label><?php if($displaynames == "false"){ echo $user_language['minecraft_username']; } else { echo $user_language['username']; } ?></label>
                <input class="form-control" type="text" name="username" id="username" value="<?php echo escape(Input::get('username')); ?>" autocomplete="off">
              </div>
              <?php if($displaynames == "true"){ ?>
              <div class="form-group">
                <label><?php echo $user_language['minecraft_username']; ?></label>
                <input class="form-control" type="text" name="mcname" id="mcname" value="<?php echo escape(Input::get('mcname')); ?>" autocomplete="off">
              </div>
              <?php } ?>
              <div class="form-group">
                <label><?php echo $user_language['email']; ?></label>
                <input class="form-control" type="text" name="email" id="email" value="<?php echo escape(Input::get('email')); ?>">
              </div>
              <div class="form-group">
                <label><?php echo $user_language['password']; ?></label>
                <input class="form-control" type="password" name="password" id="password">
              </div>
              <div class="form-group">
                <label><?php echo $user_language['confirm_password']; ?></label>
                <input class="form-control" type="password" name="password_again" id="password_again">
              </div>
              <div class="form-group">
                <label><?php echo $admin_language['group']; ?></label>
          ...
          <?php
            ...
            ?>
          <div class="panel-body">
            <h4 class="inline"><?php echo htmlspecialchars($individual[0]->username) ?></h4>
            <span class="pull-right">
              <?php if($individual[0]->active == 0){ ?>
              <a href="/admin/users/?user=<?php echo $individual[0]->id; ?>&amp;action=validate" class="btn btn-success"><?php echo $admin_language['validate_user']; ?></a>
              <?php } ?>
              <div class="btn-group">
            ...
            <form role="form" action="" method="post">
              ...
              <?php $groups = $queries->orderAll('groups', 'name', 'ASC'); ?>
              <div class="form-group">
