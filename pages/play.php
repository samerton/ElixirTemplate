...
<html lang="en">
  <head>
    ...
    <?php $title = $navbar_language['play']; ?>
  ...
  <body>
    <?php
      ...
      foreach($servers as $server){
      	...
      	// Query servers
      	$server_status_string .= '<h4 style="margin-bottom:10px;">' . htmlspecialchars($server->name) . '</h4>';
      	if($external_query == 'false'){
    ...
    <?php $smarty->display('styles/templates/' . $template . '/play.tpl'); ?>
