...
if($custom_usernames == "false"){ 
    $username_text = $user_language['minecraft_username']; 
} else { 
    $username_text = $user_language['username'];
};

// Generate code for page
$form_content = '
<div class="form-group">
    <label class="field-name">' . $username_text . '</label>
...
'<div class="form-group">
    ...
    <a class="forgot-password" href="/forgot_password">' . $user_language['forgot_password'] . '?</a>
</div>' . PHP_EOL;

$submit = '
<input type="hidden" name="token" value="' .  Token::generate() . '">
<button type="submit" class="btn btn-primary btn-md">' . $user_language['sign_in'] . '</button>
<label for="remember" style="margin-left:10px">
...
<html lang="en">
  ...
  <body>
    ...
    <?php $smarty->display('styles/templates/' . $template . '/signin.tpl'); ?>
