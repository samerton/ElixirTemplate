...
<html lang="en">
  ...
  <body>
    ...
    <div class="container index">
      <h3 class="inline"><?php echo $user_language['private_messages']; ?></h3>
      <span class="pull-right"><a href="/user/messaging/?action=new" class="btn btn-primary"><?php echo $user_language['new_message']; ?></a></span>
      <br /><br />
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
          <?php if(!isset($_GET['action']) && !isset($_GET['mid'])){ ?>
          <div class="panel-body">
            ...
            <table class="table table-formed">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><a href="/user/messaging/?mid=<?php echo $pm['id']; ?>"><?php echo $pm['title']; ?></a></td>
                    <td><?php echo $user_string; ?></td>
                    <td><?php echo date('d M Y, H:i', $pm['date']); ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
            <?php } else { echo $user_language['no_messages']; } ?>
          </div>
          <?php
          ...
          ?>
          <div class="panel-body">
            <h4><?php echo $user_language['new_message']; ?></h4>
            <br /><br />
            <form action="" method="post">
              ...
              <div class="form-group">
                <label for="InputTo"><?php echo $user_language['to']; ?> <span style="float:right"><?php echo $user_language['separate_users_with_comma']; ?></span></label>
          ...
          <div class="panel-body post-body">
            <h4 class="inline"><?php echo $pm[0]->title; ?></h4>
            <span class="pull-right"><a href="/user/messaging/?action=delete&amp;mid=<?php echo $pm[0]->id; ?>" class="btn btn-danger" onclick="return confirm('<?php echo $user_language['confirm_message_deletion']; ?>');"><?php echo $user_language['delete_message']; ?></a></span>
            <br />
            <span class="tagline">By <?php echo $user_string; ?></span>
            <br /><br />
            <?php foreach($pm_replies as $reply){ ?>
            <div class="panel-body">
              <div class="message-content">
                <?php 
                  if($pm[0]->author_id != 0){
                    echo '<a href="/profile/' . htmlspecialchars($user->idToMCName($reply->user_id)) . '"><strong>' . htmlspecialchars($user->idToName($reply->user_id)) . '</strong></a>'; 
                  } else {
                    echo '<span>' . $user_language['system'] . '</span>';
                  }
                ?>
                <br />
                <?php
              ...
              <div class="message-meta">
                <?php echo date('d M Y, H:i', $reply->created); ?>
              </div>
            </div>
            <br />
            <?php } ?>
