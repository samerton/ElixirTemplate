  ...
  <body>
    ...
    <div class="container index">	
      ...
      <span class="pull-right">
	    <?php if($uuid_linking == '1' && (strtotime("-30 days") > $user->data()->last_username_update)){ ?>
	  ...
	  <div class="row">
		...
		<div class="col-md-9">
		  <div class="panel-body">
			<?php if(Session::exists('settings_avatar_error')){ echo Session::flash('settings_avatar_error'); } ?>
            <?php if(Session::exists('usercp_settings')){ echo Session::flash('usercp_settings'); } ?>
			...
			<form action="" method="post">
			  ...
			  <div class="form-group">
				...
				<textarea rows="10" name="signature" id="signature" style="margin-top:5px;">
					<?php echo $signature; ?>
				</textarea>
			  </div>
			  <?php if($avatar_enabled === '1'){ ?>
			    <div class="form-group">
			...
			<?php if($avatar_enabled === '1'){ ?>
			  <div class="panel-body">
			    <form action="/user/avatar_upload/" method="post" enctype="multipart/form-data">
			      <span class="field-name"><?php echo $user_language['upload_an_avatar']; ?></span>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="usernameModalLabel">Update Minecraft Name</h4>
		  </div>
