...
$footer_nav = '<ul class="nav nav-pills dropup">';
if(isset($page_loading) && $page_loading == '1'){
	$footer_nav .= '<li><a data-toggle="tooltip" id="page_load_tooltip" title="Page loading.."><i class="fa fa-tachometer fa-fw"></i></a></li>';
}
