...
<div class="panel-body post-body">
  ...
  <h4><?php echo $donate_language['donate']; ?></h4>
  <span class="tagline"><b>Authors:</b> Samerton<br />
  <b>Version:</b> 1.1.4<br />
  <b>Description:</b> Integrate a donation store with your website</span>
  <br /><br />
  <?php
    ...
    ?>
  <div class="panel-body">
    <h5>Donation Store</h5>
    <br />
    <form action="" method="post">
      <label>Donation Plugin</label><br />
      ...
      <div class="form-group">
        ...
        <label for="integrated">&nbsp;&nbsp;Integrated store?</label> <span data-toggle="popover" data-content="Having this disabled will send users to your external store instead of the integrated page.">&nbsp;<i class="fas fa-question-circle"></i></span>
      </div>
      <div class="form-group">
        ...
        <label for="guests">&nbsp;&nbsp;Allow guests?</label> <span data-toggle="popover" data-content="Allow guests to view the store?">&nbsp;<i class="fas fa-question-circle"></i></span>
      </div>
      <div class="form-group">
  ...
  <div class="panel-body" style="margin:-15px">
    ...
    ?>
    <h4>Packages</h4>
    <span class="tagline">Click to edit package descriptions:</span>
    <br /><br />
    <?php
    ...
    ?>
    <h4 class="inline">Editing package <?php echo htmlspecialchars($package->name); ?></h4>
  ...
  ?>
  <h4 class="inline">Synchronise</h4>
  <a onclick="syncDonate();" class="btn btn-primary pull-right">Synchronise</a>
  <br />
  <span class="tagline">The following button will synchronise your web store with your site database.<br />Please be patient, this process may take a while...</span>
  <br /><br />
  <div class="panel-body">
    <h5>Automating the synchronisation</h5>
    <br />
