...
<div class="panel-body">
  <h4><?php echo $members_language['members']; ?></h4>
  <span class="tagline"><b>Authors:</b> Partydragen and Samerton<br />
  <b>Version:</b> 1.2.2<br />
  <b>Description:</b> Adds a page where users can check all registered members along with staff groups</span>
  <br /><br />
