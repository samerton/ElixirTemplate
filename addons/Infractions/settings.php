...
<div class="panel-body post-body">
  <h4><?php echo $infractions_language['infractions']; ?></h4>
  <span class="tagline"><b>Authors:</b> Samerton<br />
  <b>Contributors:</b> Partydragen, relavis<br />
  <b>Version:</b> 1.1.0<br />
  <b>Description:</b> Integrate your server infractions with your website</span>
  <br /><br />
...
<h5>Infractions Settings</h5>
<br />
<form action="" method="post">
  <label>Infractions Plugin</label> <span data-toggle="modal" data-target="#helpModal">&nbsp;<i class="fas fa-question-circle" aria-hidden="true"></i></span><br />
